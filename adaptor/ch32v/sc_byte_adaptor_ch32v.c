...
static int start_transmit(struct sc_byte_adaptor_ch32v *self);
static int stop_transmit(struct sc_byte_adaptor_ch32v *self);
static int write_byte(struct sc_byte_adaptor_ch32v *self, int data);
