#include "sc_st7735_esp32_swspi.h"
#include "driver/gpio.h"
#include "driver/spi_master.h"
#include "sc_adaptor.h"
#include "sc_common.h"

static int start_transmit(struct st7735_adaptor_esp32_swspi *self);
static int stop_transmit(struct st7735_adaptor_esp32_swspi *self);
static int write_data(struct st7735_adaptor_esp32_swspi *self, int data);
static int write_cmd(struct st7735_adaptor_esp32_swspi *self, int data);
...
static int write_byte(struct st7735_adaptor_esp32_swspi *self, int data)
{
	int i;
